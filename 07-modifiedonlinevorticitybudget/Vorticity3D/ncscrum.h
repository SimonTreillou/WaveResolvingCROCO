...
!
! ** DIAGNOSTICS_VRT3D **
!  indxvrt3dXadv,indxvrt3dYadv   : xi-, eta- advection terms
!  indxvrt3dVadv                 : vertical advection term
!  indxvrt3dPrsgrd               : pressure gradient term
!  indxvrt3dCor                  : Coriolis term
!  indxvrt3dstretch              : xi-,      stretching terms
!  indxvrt3dadvecti              : xi-,      advection terms
!  indxvrt3dHdiff                : horizontal diffusion term (implicit)
!  indxvrt3dHmix, indxvrt3dVmix  : horizontal and vertical mixing terms
!  indxvrt3drate                 : tendency term
!  indxvrt3dfast                 : Fast term
!  indxvrt3dVmix2                : Nudging (2D/3D coupling) term
!  indxvrtBaro                   : Barotropic coupling term
!
! ** DIAGNOSTICS_EK **
...
# ifdef DIAGNOSTICS_VRT3D
      integer indxvrt3dXadv,indxvrt3dYadv,indxvrt3dHdiff,indxvrt3dCor,
     &        indxvrt3dVmix,indxvrt3dHmix,
     &        indxvrt3dVmix2, indxvrt3drate,
     &        indxvrt3dstretch, indxvrt3dadvecti,
     &        indxvrt3dVadv, indxvrt3dPrsgrd
      parameter (indxvrt3drate=indxV+ntrc_temp+ntrc_salt
     &                        +ntrc_mld+ntrc_pas+
     &                        +ntrc_bio+ntrc_sed
     &                        +ntrc_diats+ntrc_diauv+1,
     &           indxvrt3dXadv=indxvrt3drate+1,
     &           indxvrt3dYadv=indxvrt3dXadv+1,
     &           indxvrt3dVadv=indxvrt3dYadv+1,
     &           indxvrt3dPrsgrd=indxvrt3dVadv+1,
     &           indxvrt3dVmix=indxvrt3dPrsgrd+1,
     &           indxvrt3dHmix=indxvrt3dVmix+1,
     &           indxvrt3dHdiff=indxvrt3dHmix+1,
     &           indxvrt3dCor=indxvrt3dHdiff+1,
     &           indxvrt3dVmix2=indxvrt3dCor+1)
#  ifdef DIAGNOSTICS_BARO
      integer indxvrtBaro
      parameter (indxvrtBaro=indxvrt3dVmix2+1)
#  endif
#  ifdef M3FAST
      integer indxvrt3dfast
      parameter (indxvrt3dfast=indxvrt3dVmix2+2)
#  endif
# endif
...
#  ifdef ABL1D
     ...
     &        indxZR  , indxZW  ,
     &        indxHZR , indxHZW
      parameter (indxUHPG = indxabl_pu_dta+20, 
     &           indxVHPG = indxabl_pu_dta+21,
     &           indxZR   = indxabl_pu_dta+22, 
     &           indxZW   = indxabl_pu_dta+23,
     &           indxHZR  = indxabl_pu_dta+24, 
     &           indxHZW  = indxabl_pu_dta+25)
#  endif
# endif
#endif /* SOLVE3D */
...
# endif
# ifdef DIAGNOSTICS_VRT3D
      integer nciddiags_vrt3d, nrecdiags_vrt3d, nrpfdiags_vrt3d
     &      , diags_vrt3dTime, diags_vrt3dTime2, diags_vrt3dTstep
     &      , diags_vrt3dXadv(2), diags_vrt3dYadv(2), diags_vrt3dHdiff(2)
     &      , diags_vrt3dstretch(2), diags_vrt3dadvecti(2)
     &      , diags_vrt3dCor(2)
     &      , diags_vrt3dVmix(2), diags_vrt3drate(2), diags_vrt3dHmix(2)
     &      , diags_vrt3dVmix2(2)
     &      , diags_vrt3dVadv(2), diags_vrt3dPrsgrd(2)
#  ifdef DIAGNOSTICS_BARO
     &      , diags_vrtBaro(2)
#  endif
#  ifdef M3FAST
...
#  ifdef DIAGNOSTICS_VRT
     ...
     &      , diags_vrtVmix2_avg(2), diags_vrtWind_avg(2)
     &      , diags_vrtDrag_avg(2)
#   ifdef DIAGNOSTICS_BARO
     &      , diags_vrtBaro_avg(2)
#   endif
...
#  endif
#  ifdef DIAGNOSTICS_VRT3D
       integer nciddiags_vrt3d_avg, nrecdiags_vrt3d_avg, nrpfdiags_vrt3d_avg
     &      , diags_vrt3dTime_avg, diags_vrt3dTime2_avg, diags_vrt3dTstep_avg
     &      , diags_vrt3dXadv_avg(2), diags_vrt3dYadv_avg(2)
     &      , diags_vrt3dstretch_avg(2), diags_vrt3dadvecti_avg(2)
     &      , diags_vrt3dHdiff_avg(2), diags_vrt3dVadv_avg(2)
     &      , diags_vrt3dCor_avg(2)
     &      , diags_vrt3dPrsgrd_avg(2)
     &      , diags_vrt3dVmix_avg(2), diags_vrt3drate_avg(2), diags_vrt3dHmix_avg(2)
     &      , diags_vrt3dVmix2_avg(2)
#   ifdef DIAGNOSTICS_BARO
     &      , diags_vrtBaro_avg(2)
#   endif
#   ifdef M3FAST
     &      , diags_vrt3dfast_avg(2)
#   endif
#  endif
#  ifdef DIAGNOSTICS_EK
     ...
     &      , diags_ekHmix_avg(2)
     &      , diags_ekVmix_avg(2), diags_ekrate_avg(2)
     &      , diags_ekvol_avg(2)
     &      , diags_ekVmix2_avg(2), diags_ekWind_avg(2)
     &      , diags_ekDrag_avg(2)
#   ifdef DIAGNOSTICS_BARO
     &      , diags_ekBaro_avg(2)
#   endif
...
#endif
#ifdef DIAGNOSTICS_VRT3D
     &      , nciddiags_vrt3d, nrecdiags_vrt3d, nrpfdiags_vrt3d
     &      , diags_vrt3dTime, diags_vrt3dTime2, diags_vrt3dTstep
     &      , diags_vrt3dXadv, diags_vrt3dYadv, diags_vrt3dHdiff
     &      , diags_vrt3dCor, diags_vrt3dVadv, diags_vrt3dPrsgrd
     &      , diags_vrt3dVmix,  diags_vrt3dHmix
     &      , diags_vrt3drate
     &      , diags_vrt3dVmix2
     &      , diags_vrt3dstretch, diags_vrt3dadvecti
# ifdef DIAGNOSTICS_BARO
     &      , diags_vrtBaro
# endif
# ifdef M3FAST
...
# endif
# ifdef AVERAGES
     &      , nciddiags_vrt3d_avg, nrecdiags_vrt3d_avg, nrpfdiags_vrt3d_avg
     &      , diags_vrt3dTime_avg, diags_vrt3dTime2_avg, diags_vrt3dTstep_avg
     &      , diags_vrt3dXadv_avg, diags_vrt3dYadv_avg, diags_vrt3dHdiff_avg
     &      , diags_vrt3dCor_avg
     &      , diags_vrtVmix_avg, diags_vrt3drate_avg, diags_vrt3dVadv_avg
     &      , diags_vrt3dVmix2_avg
     &      , diags_vrt3dstretch_avg, diags_vrt3dadvecti_avg
     &      , diags_vrt3dPrsgrd_avg
#  ifdef DIAGNOSTICS_BARO
     &      , diags_vrtBaro_avg
#  endif
#  ifdef M3FAST
